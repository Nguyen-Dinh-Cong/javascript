...
import { FaFacebook, FaTiktok, FaYoutube, FaInstagram, FaShippingFast, FaMedal } from "react-icons/fa";
          ...
          <div class="container">
            <div class="home-policy">
              <div class="row">
                <div clas="col-4">
                  <a href="#">
                  <p style={{fontSize:'40px'}}><FaShippingFast/></p> 
                  <h5><strong>Giao hàng nhanh, miễn phí</strong></h5>
                  <p>Đơn hàng lớn hơn 900K hoặc đăng ký tài khoản</p>
                  </a>
                </div>
                <div clas="col-4">
                  <a href="#">
                    <p style={{fontSize:'40px'}}><FaArrowRightArrowLeft/></p> 
                    <h5><strong>Trả hàng, bảo hành</strong></h5>
                    <p>Trả hàng, đổi hàng miến phí trong vòng 15 ngày</p>
                  </a>
                </div>
                <div clas="col-4">
                  <a href="#">
                    <p style={{fontSize:'40px'}}><FaMedal/></p> 
                    <h5><strong>Chính hãng</strong></h5>
                    <p>Sản phẩm chính hãng. Được nhập 100% từ hãng</p>
                  </a>
                </div>
              </div>
            </div>
